<%/*
      ...
      // PAGINA CHE CONTIENE IL TEMPLATE DELLE PAGINE DI POPUP SENZA L'OBBLIGATORIETA' DEL TITOLO
      // E CON IL CORPO CHE SI ESTENDE PER LA TOTALITA' DELLA PAGINA
    %>
...
<div class="contenitore-errori-arealavoro"><jsp:include page="/WEB-INF/pages/commons/javascriptMsg.jsp" /></div>
    ...
    <!--
    	...
    	<c:if test='${param.abilitaNuovo eq 1}'>
				document.forms[0].action+="?abilitaNuovo=1";
    	</c:if>
    //-->
    </script>
</BODY>
