...
<c:choose>
	...
	<c:when test='${param.condizioneBloccoAllmail or (isProceduraTelematica ne "true")}'>
...
<c:when test="${param.tipoDettaglio eq 1}">
				...
				<gene:campoScheda campo="ALLMAIL_${param.contatore}" entita="DOCUMGARA" campoFittizio="true"  definizione="T1;0;;SN;G1ALLMAIL" value="${allegaMail}"  modificabile='${!param.condizioneBloccoAllmail and campiEsistentiModificabiliDaProfilo}' visibile='${isProceduraTelematica}'/>
...
<c:otherwise>
			<gene:campoScheda campo="CODGAR_${param.contatore}" entita="DOCUMGARA" campoFittizio="true" visibile="false" definizione="T21;1;;;CODGARDG" value="${codiceGara}"/>
				...
				<gene:campoScheda campo="ALLMAIL_${param.contatore}" entita="DOCUMGARA" campoFittizio="true"  definizione="T1;0;;SN;G1ALLMAIL" value="${allegaMail}" defaultValue="${allegaMail}" modificabile='${!param.condizioneBloccoAllmail}' visibile='${isProceduraTelematica}'/>
