...
<input type="hidden" name="filtroDocumentazione" value="${gruppo}"/>
	...
	<gene:campoScheda>	
		...
		<td class="comandi-dettaglio" colSpan="2">
			...
			<c:otherwise>
				...
				<c:if test="${autorizzatoModifiche ne '2' and isIntegrazionePortaleAlice eq 'true' and (gruppo eq 2 or (gruppo eq 3 and garaElencoCatalogo)) and gene:checkProt(pageContext, 'FUNZ.VIS.ALT.GARE.PubblicaSuPortale')}">
	...
	<gene:redefineInsert name="addToAzioni" >
		...
		<c:if test='${autorizzatoModifiche ne "2" and modoAperturaScheda eq "VISUALIZZA" and isIntegrazionePortaleAlice eq "true" and (gruppo eq 2 or (gruppo eq 3 and garaElencoCatalogo))
...
function apriPopupInsertPredefiniti() {
	...
	var href = "href=gare/archdocg/conferma-ins-doc-predefiniti.jsp?codgar="+getValue("GARE_CODGAR1")+"&ngara="+getValue("GARE_NGARA")+"&lottoDiGara=" + lottoDiGara;
