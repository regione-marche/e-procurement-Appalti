...
<div style="width:97%;">
	...
	<gene:template file="popup-template.jsp">
		...
		<c:set var="cifraturaBuste" value='${gene:callFunction3("it.eldasoft.sil.pg.tags.funzioni.EsisteBustaCifrataFunction", pageContext, ngara, "FS11A")}'/>
				
		<gene:redefineInsert name="addHistory" />
		<gene:redefineInsert name="gestioneHistory" />
		<gene:setString name="titoloMaschera" value='Acquisizione busta amministrativa' />
		...
		<gene:redefineInsert name="corpo">
			...
			<input type="hidden" id="garaInversa" value="${garaInversa}" />
			...
			<table class="dettaglio-notab">
				<tr id="sezioneIniziale">
					<td class="valore-dato" colspan="2">
						<br>
						Mediante questa funzione &egrave; possibile procedere all'acquisizione della busta amministrativa della ditta '${nomimo}'.
						<br><br>
				...
				<c:if test="${cifraturaBuste eq 'true'}">
						<tr id="rowPWD">
							...
							<td class="valore-dato">
								<input id="PWD" name="PWD" title="Password per la decifratura della busta" class="testo" type="password" size="24" value="${sessionScope.passBusteA }" maxlength="100" />
				...
				<tr id="sezioneComandiIniziali">
					<td colspan="2" class="comandi-dettaglio">
						<INPUT type="button" class="bottone-azione" value="Conferma" title="Conferma" onclick="javascript:attivaAJAX();">
		...
		<gene:javaScript>
			...
			function inizializzaAvanzamento(ngara,dittao) {
				...
				$.ajax({
					...
					url: "pg/AvanzamentoApDocAJAX.do?ngara=" + ngara + "&dittao=" + dittao,
			...
			function avanzamento() {
				...
				$.ajax({
					...
					url: "pg/AvanzamentoApDocAJAX.do?ngara=" + ngara,
					success: function(res){
						var curr = res.cnt;
			...
			function attivaAJAX(){
				...
				var garaInversa = $("#garaInversa").val();
				...
				$.ajax({
					...
					url: "pg/AttivaApDocAJAX.do?ngara=" + ngara + "&dittao=" + dittao + "&password=" + encodeURIComponent(pwd) + "&garaInversa="+garaInversa + "&pswCryptata=" + pswCryptata,
					success: function(res){
						esito= res.Esito;
