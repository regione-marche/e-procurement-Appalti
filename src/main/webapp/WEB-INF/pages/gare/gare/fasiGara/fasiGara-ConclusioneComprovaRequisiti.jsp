 ...
 */
  ...
  * del wizard Fasi di gara (quinto step)
  *
  * Osservazione: questa jsp e' stata copiata e modifica per le gare a lotti ad
  * offerta unica (vedi fasiGara-ConclusioneComprovaRequisiti-OffertaUnica.jsp)
  *
  */
%>
...
<c:set var="isNavigazioneDisattiva" value="${isNavigazioneDisabilitata}" />
	...
	<tr>
		<td ${stileDati} >
				<gene:formScheda entita="GARE" where="${whereGARE}" gestisciProtezioni="true" gestore="it.eldasoft.sil.pg.tags.gestori.submit.GestoreFasiGara_ConclusComprovaRequisiti">
					...
					<gene:gruppoCampi>
						...
						<gene:campoScheda campo="DVCOMPREQ" />
						...
						<gene:campoScheda campo="NOTCOMPREQ" />
						<gene:campoScheda campo="DINVDOCTEC" />
					</gene:gruppoCampi>
