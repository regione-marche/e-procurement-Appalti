...
<c:set var="tmp" value='${gene:callFunction2("it.eldasoft.sil.pg.tags.funzioni.GetAssociazioneGaraAQFunction", pageContext, ngara)}' />

<c:set var="where" value="(C0OGGASS.C0AENT='GARECONT' AND C0OGGASS.C0AKEY1='${c0akey1}' AND C0OGGASS.C0AKEY2='${c0akey2}')" />
		...
		<table class="lista">
			<tr>
				<td><gene:formLista entita="C0OGGASS" pagesize="20" tableclass="datilista" gestisciProtezioni="true" sortColumn="-2;4" where="${where}" >
					...
					<gene:campoLista title="Documento per" campo="TIPO" campoFittizio="true" definizione="T10"  value='Contratto AQ' width="100"/>										
