...
<c:set var="integrazioneWSDM" value='${gene:callFunction3("it.eldasoft.sil.pg.tags.funzioni.EsisteIntegrazioneWSDNFunction", pageContext, codgar1,idconfi)}'/>
<c:set var="tipologiaGara" value='${param.tipologiaGara}' />

<c:if test="${integrazioneWSDM =='1'}">
	<c:set var="esisteFascicoloAssociato" value='${gene:callFunction4("it.eldasoft.sil.pg.tags.funzioni.EsisteFascicoloAssociatoFunction", pageContext, "GARE", gene:getValCampo(key,"NGARA"),idconfi)}' scope="request"/>
</c:if>
	...
	<gene:callFunction obj="it.eldasoft.sil.pg.tags.funzioni.GestionePubblicazioniBandoFunction" parametro="${codgar1}" />
	<jsp:include page="/WEB-INF/pages/commons/interno-scheda-multipla.jsp" >
		<jsp:param name="entita" value='PUBBLI'/>
		<jsp:param name="chiave" value='${codgar1}'/>
	...
	<c:set var="condizioneModificaSezioneProfilo" value='${gene:checkProt(pageContext,"SEZ.MOD.GARE.GARE-scheda.PUBBLICITA.PUBBANDO") }'/>
...
function apriPopupInsertPredefiniti() {
	var href = "href=gare/commons/conferma-ins-pubbli-predefinite.jsp?codgar="+getValue("GARE_CODGAR1")+"&ngara="+getValue("GARE_NGARA")+"&bando=1&genere=${tipologiaGara}";
