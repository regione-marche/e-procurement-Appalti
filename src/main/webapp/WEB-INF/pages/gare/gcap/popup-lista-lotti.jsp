...
<gene:callFunction obj="it.eldasoft.sil.pg.tags.funzioni.archWhereFunctions.ComponiWhereV_GCAP_LOTTIFunction" />

<gene:template file="popup-template.jsp">
	<gene:setString name="titoloMaschera" value="Selezione del lotto di gara"/>
	<gene:redefineInsert name="corpo">
		<gene:formLista pagesize="25" tableclass="datilista" entita="V_GCAP_LOTTI" inserisciDaArchivio="false" gestisciProtezioni="true" sortColumn="2">
			...
			<gene:campoLista campo="NORVOC_MAX" visibile="false"/>
		</gene:formLista>
  </gene:redefineInsert>
</gene:template>
