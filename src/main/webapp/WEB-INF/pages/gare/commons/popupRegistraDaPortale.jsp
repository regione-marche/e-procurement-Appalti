...
<gene:setString name="titoloMaschera" value='Acquisizione registrazione da portale Appalti' />
...
<c:if test='${requestScope.erroreAcquisizione eq "1"}' >
	...
	<gene:javaScript>
		...
		function conferma() {
			document.forms[0].jspPathTo.value="gare/commons/popupRegistraDaPortale.jsp";
			schedaConferma();
		}
