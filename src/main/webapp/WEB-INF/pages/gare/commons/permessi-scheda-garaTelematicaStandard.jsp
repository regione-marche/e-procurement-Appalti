...
<gene:template file="scheda-template.jsp">
	...
	<gene:redefineInsert name="head" >
		...
		<script type="text/javascript" src="${contextPath}/js/jquery.pg.permessi.garatelematica.standard.js"></script>
	...
	<gene:redefineInsert name="corpo">
		...
		<form id="formVisualizzaPermessiUtentiStandard" name="formVisualizzaPermessiUtenti" action="${pageContext.request.contextPath}/pg/VisualizzaPermessiUtentiGaraTelematicaStandard.do" method="post">
		...
		<form id="formModificaPermessiUtentiStandard" name="formModificaPermessiUtentiStandard" action="${pageContext.request.contextPath}/pg/ModificaPermessiUtentiGaraTelematicaStandard.do" method="post">
			<input type="hidden" name="metodo" id="metodo" value="apri" />
			<input type="hidden" name="codgar" id="codgar" value="${codgar}" />
			<input type="hidden" name="operation" id="operation" value="${operation}" />
			<input type="hidden" name="permessimodificabili" id="permessimodificabili" value="${permessimodificabili}" />
