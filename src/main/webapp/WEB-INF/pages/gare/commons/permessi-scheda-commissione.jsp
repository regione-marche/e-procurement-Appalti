...
<gene:template file="scheda-template.jsp">
	...
	<gene:redefineInsert name="head" >
		...
		<script type="text/javascript" src="${contextPath}/js/jquery.pg.permessi.commissione.js"></script>
	...
	<gene:redefineInsert name="corpo">
		...
		<jsp:include page="permessi-scheda-titolo.jsp" />
		<gene:setString name="titoloMaschera" value="Condivisione e protezione della gara ${fn:replace(codgar, '$', '')} per i componenti commissione" />

		<form id="formVisualizzaPermessiUtenti" name="formVisualizzaPermessiUtenti" action="${pageContext.request.contextPath}/pg/VisualizzaPermessiUtentiCommissione.do" method="post">
		...
		<form id="formModificaPermessiUtentiCommissione" name="formModificaPermessiUtentiCommissione" action="${pageContext.request.contextPath}/pg/ModificaPermessiUtentiCommissione.do" method="post">
			<input type="hidden" name="metodo" id="metodo" value="apri" />
			<input type="hidden" name="codgar" id="codgar" value="${codgar}" />
			<input type="hidden" name="operation" id="operation" value="${operation}" />
			<input type="hidden" name="permessimodificabili" id="permessimodificabili" value="${permessimodificabili}" />
