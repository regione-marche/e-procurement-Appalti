...
<gene:template file="scheda-template.jsp">
	...
	<gene:redefineInsert name="head" >
		...
		<script type="text/javascript" src="${contextPath}/js/jquery.pg.permessi.standard.js"></script>
	...
	<gene:redefineInsert name="corpo">
		...
		<form id="formVisualizzaPermessiUtenti" name="formVisualizzaPermessiUtenti" action="${pageContext.request.contextPath}/pg/VisualizzaPermessiUtentiStandard.do" method="post">
		...
		<form id="formModificaPermessiUtenti" name="formModificaPermessiUtenti" action="${pageContext.request.contextPath}/pg/ModificaPermessiUtentiStandard.do" method="post">
			<input type="hidden" name="metodo" id="metodo" value="apri" />
			<input type="hidden" name="codgar" id="codgar" value="${codgar}" />
			<input type="hidden" name="operation" id="operation" value="${operation}" />
			<input type="hidden" name="permessimodificabili" id="permessimodificabili" value="${permessimodificabili}" />
	...
	<c:choose>
		...
		<c:otherwise>
			if (confirm('<fmt:message key="info.permessi.condivisionePredefinita"/>')) {
				...
				formVisualizzaPermessiUtenti.metodo.value = "setPermessiPredefiniti";
