...
<gene:template file="scheda-template.jsp">
	...
	<gene:redefineInsert name="head" >
		...
		<script type="text/javascript" src="${contextPath}/js/jquery.wserp.allegati.js"></script>
	...
	<gene:setString name="titoloMaschera" value="Lista allegati ${genereTitolo} ${param.codice} " />
	...
	<gene:redefineInsert name="corpo">
		...
		<table class="dettaglio-notab">
			<tr>
				<td>
					<br>
					<div id="allegatiContainer" style="margin-left:8px; width: 98%"></div>
				    <br>
				</td>
			</tr>
		</table>
