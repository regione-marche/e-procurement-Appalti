...
<gene:template file="scheda-template.jsp">
	...
	<gene:redefineInsert name="head" >
		...
		<script type="text/javascript" src="${contextPath}/js/jquery.pg.permessi.ricercamercato.js"></script>
	...
	<gene:redefineInsert name="corpo">
		...
		<gene:setString name="titoloMaschera" value="Punto ordinante e punto istruttore della ricerca di mercato ${codric}" />

		<form id="formVisualizzaPermessiUtentiStandard" name="formVisualizzaPermessiUtentiStandard" action="${pageContext.request.contextPath}/pg/VisualizzaPermessiUtentiRicercaMercato.do" method="post">
			...
			<input type="hidden" name="codric" id="codric" value="${codric}" />
		</form> 
		
		<form id="formModificaPermessiUtentiStandard" name="formModificaPermessiUtentiStandard" action="${pageContext.request.contextPath}/pg/ModificaPermessiUtentiRicercaMercato.do" method="post">
			<input type="hidden" name="metodo" id="metodo" value="apri" />
			<input type="hidden" name="id" id="id" value="${id}" />
			<input type="hidden" name="genereGara" id="genereGara" value="" />
			<input type="hidden" name="operation" id="operation" value="${operation}" />
