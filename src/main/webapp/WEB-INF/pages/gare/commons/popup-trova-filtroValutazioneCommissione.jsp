...
<gene:template file="popup-template.jsp" >
	...
	<br>
		...
		<gene:formTrova entita="DITG" gestore="it.eldasoft.sil.pg.tags.gestori.decoratori.trova.gestori.FiltroValutazioneCommissioneGestoreTrova" >	
			...
			<input type="hidden" name="isValutazioneCommissione" value="${isValutazioneCommissione}" />
			<input type="hidden" name="tippar" value="${tippar}">
			<input type="hidden" name="codiceGaraDitg" value="${codiceGaraDitg}" />
		...
		<gene:javaScript>	
			...
			document.forms[0].action+= "?tipo=Valutazione&entFiltro=DITG";
