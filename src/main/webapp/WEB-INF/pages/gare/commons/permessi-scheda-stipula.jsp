...
<gene:template file="scheda-template.jsp">
	...
	<gene:redefineInsert name="head" >
		...
		<script type="text/javascript" src="${contextPath}/js/jquery.pg.permessi.stipula.js"></script>
	...
	<gene:redefineInsert name="corpo">
		...
		<gene:setString name="titoloMaschera" value="Condividi e proteggi stipula ${codstipula}" />

		<form id="formVisualizzaPermessiUtentiStandard" name="formVisualizzaPermessiUtentiStandard" action="${pageContext.request.contextPath}/pg/VisualizzaPermessiUtentiStipula.do" method="post">
		...
		<form id="formModificaPermessiUtentiStandard" name="formModificaPermessiUtentiStandard" action="${pageContext.request.contextPath}/pg/ModificaPermessiUtentiStipula.do" method="post">
			<input type="hidden" name="metodo" id="metodo" value="apri" />
			<input type="hidden" name="id" id="id" value="${id}" />
			<input type="hidden" name="operation" id="operation" value="${operation}" />
			<input type="hidden" name="permessimodificabili" id="permessimodificabili" value="${permessimodificabili}" />
