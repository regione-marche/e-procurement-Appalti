...
<gene:template file="popup-template.jsp">
	...
	<gene:redefineInsert name="corpo">
		<gene:formScheda gestisciProtezioni="false" entita="">
			...
			<gene:campoScheda campo="CPVCOD0" nome="CPVCOD0" title="" definizione="T2" gestore="it.eldasoft.sil.pl.tags.funzioni.decoratori.campi.GestoreCampoTABCPV_TABCOD0" 
				value="${fn:substring( valore, 0,2 )}" />
			<gene:campoScheda campo="CPVCOD1" nome="CPVCOD1" title="" definizione="T2" gestore="it.eldasoft.sil.pl.tags.funzioni.decoratori.campi.GestoreCampoTABCPV_TABCOD1"
				value="${fn:substring( valore, 2,4 )}" />
			<gene:campoScheda campo="CPVCOD2" nome="CPVCOD2" title="" definizione="T2" gestore="it.eldasoft.sil.pl.tags.funzioni.decoratori.campi.GestoreCampoTABCPV_TABCOD2" 
				value="${fn:substring( valore, 4,6 )}" />
			<gene:campoScheda campo="CPVCOD3" nome="CPVCOD3" title="" definizione="T2" gestore="it.eldasoft.sil.pl.tags.funzioni.decoratori.campi.GestoreCampoTABCPV_TABCOD3" 
	...
	<gene:javaScript>
		...
		function reloadCPV() {
			...
			document.location.href="${pageContext.request.contextPath}/ApriPagina.do?"+csrfToken+"&href=lavo/commons/dettaglio-codice-cpv.jsp&modo=MODIFICA&campo=${param.campo}&valore="+getValue("CPVCOD");
		}
