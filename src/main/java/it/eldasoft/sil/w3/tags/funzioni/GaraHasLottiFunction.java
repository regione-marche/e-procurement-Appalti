...
public class GaraHasLottiFunction extends AbstractFunzioneTag {

  public GaraHasLottiFunction() {
    ...
    if (!UtilityTags.SCHEDA_MODO_INSERIMENTO.equals(UtilityTags.getParametro(
      ...
      try {
        ...
        Long conteggio = (Long) sqlManager.getObject(
            "select count(*) from w3lott where numgara = ?",
            new Object[] { numgara });
        ...
        throw new JspException(
            "Errore durante il controllo del numero dei lotti", s);
      }
    }
