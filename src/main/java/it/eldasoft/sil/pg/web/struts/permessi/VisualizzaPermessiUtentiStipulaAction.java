...
public class VisualizzaPermessiUtentiStipulaAction extends DispatchActionBaseNoOpzioni {

	protected final String FORWARD_VISUALIZZA = "visualizza";

	static Logger          logger             = Logger.getLogger(VisualizzaPermessiUtentiStipulaAction.class);
	...
	public ActionForward apri(ActionMapping mapping, ActionForm form,
		...
		if (logger.isDebugEnabled()) {
	    	logger.debug("VisualizzaPermessiUtentiStipulaAction: inizio metodo");
	    }
		...
		if (logger.isDebugEnabled()) {
			logger.debug("VisualizzaPermessiUtentiStipulaAction: fine metodo");
		}
