...
public class ModificaPermessiUtentiStandardAction extends ActionBaseNoOpzioni {

  protected static final String FORWARD_MODIFICA = "modifica";

  static Logger                 logger             = Logger.getLogger(ModificaPermessiUtentiStandardAction.class);
  ...
  protected ActionForward runAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
    ...
    if (logger.isDebugEnabled()) {
    	logger.debug("ModificaPermessiUtentiAction: inizio metodo");
    }
    ...
    if (logger.isDebugEnabled()) {
    	logger.debug("ModificaPermessiUtentiAction: fine metodo");
    }
