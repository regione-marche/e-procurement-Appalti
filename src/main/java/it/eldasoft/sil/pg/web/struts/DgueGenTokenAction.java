...
public class DgueGenTokenAction extends DispatchActionBaseNoOpzioni {

  private static final String JSON_CODEIN = "codein";

  private final Logger logger = Logger.getLogger(DgueGenTokenAction.class);
  ...
  private static final String DGUE_LINK_ACTION = "/rest/dgue";
  ...
  private ActionForward defaultAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      PropsConfig mdgueUrl = null;
      
      if(apri != null) {
        mdgueUrl = pcm.getProperty(codapp, "integrazioneMDgue.url.vis");
      } else {
        mdgueUrl = pcm.getProperty(codapp, "integrazioneMDgue.url");
      }
      ...
      if(paramDgueSymKey == null 
        ...
        paramDgueJwtKey.setValore(RandomStringUtils.random(256,true,true));
