...
public class GetWSDMTabellatoByUrlAction extends Action {
  ...
  public final ActionForward execute(final ActionMapping mapping, final ActionForm form, final HttpServletRequest request,
    ...
    String urlConfigurazione = request.getParameter("url");
    WSDMConfigurazioneOutType configurazione = gestioneWSDMManager.getWsdmConfigurazione(urlConfigurazione);
