...
public class ModificaPermessiUtentiGaraTelematicaStandardAction extends ActionBaseNoOpzioni {
  ...
  protected ActionForward runAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
    ...
    if (logger.isDebugEnabled()) {
    	logger.debug("ModificaPermessiUtentiGaraTelematicaStandardAction: inizio metodo");
    }
    ...
    if (logger.isDebugEnabled()) {
    	logger.debug("ModificaPermessiUtentiGaraTelematicaStandardAction: fine metodo");
    }
