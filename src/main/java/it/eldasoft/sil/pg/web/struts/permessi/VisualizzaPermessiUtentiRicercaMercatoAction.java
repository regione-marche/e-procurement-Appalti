...
public class VisualizzaPermessiUtentiRicercaMercatoAction extends DispatchActionBaseNoOpzioni {

	protected final String FORWARD_VISUALIZZA = "visualizza";

	static Logger          logger             = Logger.getLogger(VisualizzaPermessiUtentiRicercaMercatoAction.class);
	...
	public ActionForward apri(ActionMapping mapping, ActionForm form,
		...
		if (logger.isDebugEnabled()) {
	    	logger.debug("VisualizzaPermessiUtentiRicercaMercatoAction: inizio metodo");
	    }
		...
		if (logger.isDebugEnabled()) {
			logger.debug("VisualizzaPermessiUtentiRicercaMercatoAction: fine metodo");
		}
