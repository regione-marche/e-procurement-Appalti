 ...
 */
public class DizionarioStiliExcelX {
  ...
  private static final String  FORMATO_NUMERO_CON_VIRGOLA_4 = "#,##0.00##;-#,##0.00##";
  ...
  private static final String DEFAULT_FONT_NAME = HSSFFont.FONT_ARIAL;
	...
	private Map<Integer,CellStyle> mappaStili = null;
	private Map<String,Font> mappaFonts  = null;

	public DizionarioStiliExcelX(XSSFWorkbook wb){
		this.mappaFonts = new HashMap<String,Font>();
		this.mappaStili = new HashMap<Integer,CellStyle>();
		this.creaStili(wb);
	}

	private void creaStili(XSSFWorkbook wb){
    ...
    style.setFont(this.mappaFonts.get("headerFont"));
    ...
    style.setFillForegroundColor(HSSFColor.LIGHT_ORANGE.index);
    style.setFillPattern(CellStyle.SOLID_FOREGROUND);
    style.setFont(this.mappaFonts.get("defaultFont"));
    style.setDataFormat(wb.createDataFormat().getFormat(FORMATO_STRINGA));
    this.setBorder(style);
    style.setWrapText(true);
    ...
    //Stile per le celle che contengono date, con stile default
    style = wb.createCellStyle();
    style.setFont(this.mappaFonts.get("defaultFont"));
    style.setAlignment(CellStyle.ALIGN_CENTER);
    style.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
    ...
    //this.setBorder(style);
    this.mappaStili.put(new Integer(DATA_ALIGN_CENTER_DEFAULT), style);

		Font font = wb.createFont(); // Create a new font in the workbook
    ...
    font.setColor(HSSFColor.BLACK.index);
	  ...
	  style.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
		...
		this.mappaStili.put(new Integer(DECIMALE2_ALIGN_CENTER_FRAMED), style);
	      ...
	      //Stile DECIMALE4_ALIGN_RIGHT_FRAMED
        style = wb.createCellStyle();
        style.setFont(this.mappaFonts.get("defaultFont"));
        style.setVerticalAlignment(CellStyle.VERTICAL_CENTER);
        style.setDataFormat(wb.createDataFormat().getFormat(FORMATO_NUMERO_CON_VIRGOLA_4));
        style.setAlignment(CellStyle.ALIGN_RIGHT);
        this.mappaStili.put(new Integer(DECIMALE4_ALIGN_RIGHT), style);
	          ...
	          if (indiceFormatoDati <= 2)
	        	...
	        	switch (boldWeight) {
						case 0:
							...
							break;
						case 1:
							style.setFont(this.mappaFonts.get("defaultBoldFont"));
							break;
						case 2:
							style.setFont(this.mappaFonts.get("defaultItalicFont"));
							break;
						case 3:
							style.setFont(this.mappaFonts.get("defaultBoldItalicFont"));
							break;
						}
  ...
  private void setBorder(CellStyle style) {
	...
	public CellStyle getStileExcel(int idStile){
		return this.mappaStili.get(new Integer(idStile));
	}
	...
	public static final int DECIMALE4_ALIGN_RIGHT                                                   = 510;
	public static final int DATA_ALIGN_CENTER_DEFAULT                                               = 511;
   ...
   * @param wb
   */
  private void createFormats(XSSFWorkbook wb){
