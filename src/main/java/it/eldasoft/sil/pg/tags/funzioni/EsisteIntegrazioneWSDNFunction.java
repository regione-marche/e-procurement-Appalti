...
/**
 * Controlla se esiste l'integrazione con WSDM
 *
 * @author Marcello Caminiti
 */
public class EsisteIntegrazioneWSDNFunction extends AbstractFunzioneTag {

  public EsisteIntegrazioneWSDNFunction(){
