...
/**
 * Gestore del campo W_INVCOM.COMMITT per modificare il tooltip
 * mettendo fisso il valore "Richiedente"
 *  
 * @author Marcello Caminiti
 */
public class GestoreCampoRichiedente extends AbstractGestoreCampo {
  ...
  public String getHTML(boolean visualizzazione, boolean abilitato) {
    if(campo.isVisualizzazione()) {
      ...
      buf.append("<span ");
      buf.append(UtilityTags.getHtmlAttrib("title", "Richiedente"));
      buf.append(">");
