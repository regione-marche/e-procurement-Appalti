...
/**
 * Verifica se esistono prodotti aggiudicati per quella ditta
 *
 *
 * @author Cristian Febas
 */
public class isProdottiAggiudicatiDittaFunction extends AbstractFunzioneTag {

  public isProdottiAggiudicatiDittaFunction() {
